...
Praat can only save one object at a time for you. If you have multiple objects in your object window you'd like to save in one go, you can use the script below. It can either save objects by their object name or by their id number.
